...
if __name__ == '__main__':
    ...
    # unzip file
    print('Unzip file...')
    with gzip.open(hp.data_dir + 'D_ICD_DIAGNOSES.csv.gz') as f:
        d_icd_diagnoses = pd.read_csv(f, usecols=dtype.keys(), dtype=dtype)
    ...
    # unzip file
    print('Unzip file...')
    with gzip.open(hp.data_dir + 'D_ICD_PROCEDURES.csv.gz') as f:
        d_icd_procedures = pd.read_csv(f, usecols=dtype.keys(), dtype=dtype)
