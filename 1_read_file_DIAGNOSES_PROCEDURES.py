...
if __name__ == '__main__':
    ...
    # unzip file
    print('Unzip file...')
    with gzip.open(hp.data_dir + 'DIAGNOSES_ICD.csv.gz') as f:
        diagnoses = pd.read_csv(f, usecols=dtype.keys(), dtype=dtype)
    ...
    with gzip.open(hp.data_dir + 'PROCEDURES_ICD.csv.gz') as f:
        procedures = pd.read_csv(f, usecols=dtype.keys(), dtype=dtype)
